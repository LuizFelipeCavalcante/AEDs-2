...
class Game {
    ...
    public void imprimirVarios(int i) {
        String e = " ## ";
        System.out.println("[" + String.valueOf(i) + "]" + " => " + String.valueOf(this.id) + e + this.name + e
                + this.releaseDate + e + String.valueOf(this.estimatedOwners)
                ...
                + e + "[" + imprimirArray(this.genres) + "]" + e + "[" + imprimirArrayVirgula(this.tags) + "] ##");
    }
...
class Arvore {
    ...
    private No inserirRec(String elemento, No raiz) {
    ...
    private String pesquisarRec(String elemento, No raiz) {
...
public class arvoreBinaria {
    ...
    public static void main(String[] args) {
        ...
        String matricula = "879283";

        try {
            java.io.FileWriter writer = new java.io.FileWriter("879283_arvoreBinaria.txt");
            writer.write(matricula + " " + tempoExecucao + " " + Contador.comparacoes);
            writer.close();
        } catch (Exception e) {
